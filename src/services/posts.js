...
import { getTimeRange, getPaginationMeta } from "./index.js";
/**
...
export const getSortedPosts = async (req) => {
  ...
  try {
    ...
    if (filters.scheduleDate) {
      ...
      const endDate = new Date(date.setHours(23, 59, 59, 999)); // End of the day
      query.scheduleDate = { $gte: startDate, $lte: endDate };
    }

    // Handle scheduleTime filter
